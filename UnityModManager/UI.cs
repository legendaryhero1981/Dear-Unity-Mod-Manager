    ...
    public partial class UnityModManager
    {
        public partial class UI : MonoBehaviour
        {
            ...
            private void ScaleGui()
            {
                ...
                GUI.skin.box.margin = BoxStyle.margin = RectOffset(Scale(GlobalFontSize / 4), Scale(GlobalFontSize / 2));
                ...
                ScrollViewStyle.fontSize = TextAreaStyle.fontSize = TextFieldStyle.fontSize = ToggleStyle.fontSize = BoxStyle.fontSize = BoldFontStyle.fontSize = CenterFontStyle.fontSize = NoteFontStyle.fontSize = NormalFontStyle.fontSize = ButtonStyle.fontSize = Scale(GlobalFontSize);
            ...
            private void WindowFunction(int windowId)
            {
                ...
                if (mTooltip != null && Event.current.type == EventType.Repaint)
                {
                    ...
                    GUI.Box(size.x + pos.x < mWindowRect.width ? new Rect(pos.x, pos.y + 10, size.x, size.y) : new Rect(pos.x - size.x, pos.y + 10, size.x, size.y), mTooltip.text, tooltipBox);
                }
                else
                {
